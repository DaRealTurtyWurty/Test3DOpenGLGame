...
public class ComplexParticleSystem {
	...
	public ComplexParticleSystem(ParticleTexture textureIn, float pps, float speed, float gravityComplient,
	...
	private void emitParticle(Vector3f center) {
		...
		new Particle().setActive(texture, new Vector3f(center), velocity, gravityComplient, lifeLength,
