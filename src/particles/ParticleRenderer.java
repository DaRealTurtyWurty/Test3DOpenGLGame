...
public class ParticleRenderer {
	...
	protected ParticleRenderer(ModelLoader loaderIn, Matrix4f projectionMatrix) {
		this.loader = loaderIn;
		this.vbo = loaderIn.createEmptyVbo(INSTANCE_DATA_LENGTH * MAX_INSTANCES);
		quad = this.loader.loadToVAO(VERTICES, 2);
		loaderIn.addInstancedAttrib(quad.getVaoID(), vbo, 1, 4, INSTANCE_DATA_LENGTH, 0);
		loaderIn.addInstancedAttrib(quad.getVaoID(), vbo, 2, 4, INSTANCE_DATA_LENGTH, 4);
		loaderIn.addInstancedAttrib(quad.getVaoID(), vbo, 3, 4, INSTANCE_DATA_LENGTH, 8);
		loaderIn.addInstancedAttrib(quad.getVaoID(), vbo, 4, 4, INSTANCE_DATA_LENGTH, 12);
		loaderIn.addInstancedAttrib(quad.getVaoID(), vbo, 5, 4, INSTANCE_DATA_LENGTH, 16);
		loaderIn.addInstancedAttrib(quad.getVaoID(), vbo, 6, 1, INSTANCE_DATA_LENGTH, 20);
