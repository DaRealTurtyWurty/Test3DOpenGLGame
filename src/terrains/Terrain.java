...
public class Terrain {
	...
	/**
	 * @deprecated use
	 *             <code>Terrain(int gridX, int gridZ, ModelLoader loader, TerrainTexturePack texturePack, TerrainTexture blendMap)</code>
	 *             instead.
	 * @param gridX
	 * @param gridZ
	 * @param loader
	...
	/**
	 * @deprecated use <code>Terrain.generateTerrain(loader)</code> instead
	 * @param loader
	 * @param heightMap
	 * @return
	 */
	...
	/**
	 * @deprecated use <code>Terrain.calculateNormal(x, z, generator);</code>
	 *             instead
	 * @param x
	 * @param z
	 * @param image
	...
	/**
	 * @deprecated use <code>Terrain.getHeight(x, z, generator);</code> instead
	 * @param x
	 * @param z
	 * @param image
	 * @return
